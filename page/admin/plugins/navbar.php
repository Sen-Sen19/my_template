...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img src="../../dist/img/snowflake.gif" alt="logo" height="60" width="60"> 
</div>
    <noscript>
      <br>
  ...
  <!-- Navbar -->
  <!-- <nav class="main-header navbar navbar-expand navbar-light" style="background-image: url('../../dist/img/frost.jpg');"> -->
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #5edaea;">
