          ...
          <div class="card card-gray-dark card-outline">
            ...
            <div class="card-body">
              <div class="row mb-4">
                ...
                <div class="col-sm-3">
                  <label>&nbsp;</label>
                  <button class="btn btn-block btn-primary" id="searchReqBtn" onclick="search_accounts(1, 0)"><i class="fas fa-search mr-2"></i>Search</button>
                </div>
              </div>
              <div class="table-responsive" style="height: 400px; overflow: auto; display:inline-block;">
                <table id="accounts_table" class="table table-sm table-head-fixed text-nowrap table-hover">
                  <thead style="text-align: center;">
                    <tr>
                      <th id="c_th" style="cursor: pointer;" onclick="th_order_by(1)"> # <i class="fas fa-sort-numeric-up ml-2"></i></th>
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-md-1 col-1">
                  <input type="text" list="accounts_table_paginations" class="form-control" id="accounts_table_pagination">
