<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="view.php" class="brand-link">
    <img src="../../dist/img/penguin.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="view.php" class="d-block"><?=htmlspecialchars($_SESSION['name']);?></a>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/my_template/page/user/pagination.php") {?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/my_template/page/user/load_more.php") {?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/my_template/page/user/table_switching.php") {?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/my_template/page/user/ts_lm.php") {?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/my_template/page/user/keyup_search.php") {?>
